...
- client: Cursor (Task/Composer)
- model: Composer
- prompt: literal E
- discovery: PASS — path + citação verificada no arquivo do projeto
- selection: PASS (`multiplatform-platform-architecture`)
- application: PASS 3/3
- cell: PASS

## Resposta completa

**Skill principal:** `multiplatform-platform-architecture`

**Exigência concreta (lida no arquivo):**
