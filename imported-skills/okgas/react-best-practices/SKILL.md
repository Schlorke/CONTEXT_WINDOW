...
For the complete guide with all 58 rules expanded (detailed explanations, incorrect vs correct code examples, and impact metrics), see [AGENTS.md](AGENTS.md).
